...
const CarFormAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(`${API_END_POINT_admin}/addcar`, formData, {
        headers: {
      ...
      if (res.data.message === "Car added successfully") {
        toast.success(res.data.message);
       

        // Navigate back to the car list or home (uncomment if needed)
        // navigate("/cars");
      }
    } catch (error) {
      // Handle the error
